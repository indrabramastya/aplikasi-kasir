...
$pembelian = getData("SELECT * FROM header_pembelian");
?>
    ...
    <script>
        ...
        function printDoc() {
            if (tgl1.value != "" && tgl2.value != "") {
                window.open("../report/transaksi_pembelian.php?tgl1=" + tgl1.value + "&tgl2=" + tgl2.value, "", "width=900, height=600, left=100");
            }
        }
    </script>
