...
$sqlEdit =  "SELECT*FROM _fileuser WHERE userid = $id";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="address" cols="0" rows="3" class="form-control" placeholder="Masukkan Alamat User" required><?= $user['address'] ?> </textarea>
