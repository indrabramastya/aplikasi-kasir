...
$penjualan = getData("SELECT * FROM header_penjualan");
?>
    ...
    <script>
        ...
        function printDoc() {
            if (tgl1.value != "" && tgl2.value != "") {
                window.open("../report/transaksi_penjualan.php?tgl1=" + tgl1.value + "&tgl2=" + tgl2.value, "", "width=900, height=600, left=100");
            }
        }
    </script>
