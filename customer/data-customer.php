...
if ($msg == 'updated') {
    ...
    Customer berhasil di perbaharui...
  </div>';
}
?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="del-customer.php?id=<?= $customer['id_customer'] ?>" class="btn btn-sm btn-danger" title="hapus customer" onclick="return confirm('Anda yakin untuk menghapus Customer ini ?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
