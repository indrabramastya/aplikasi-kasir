...
$alert = ''; //fungsi untuk menghapus alert sebelumnya kl ada alert
                        ...
                        <div class="row">
                            <div class="col-lg-8 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Supllier" autofocus autocomplete="off" required></input>
                                </div>
                                <div class="form-group">
                                    <label for="telpon">No Telpon</label>
                                    <input type="text" name="telpon" class="form-control" id="telpon" placeholder="No Telpon Supllier" pattern="[0-9]{5,}" title="minimal 5 angka" required></input>
                                </div>
                                <div class="form-group">
