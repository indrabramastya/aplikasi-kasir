 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
   <!-- Brand Logo -->
   <a href="<?= $main_url ?>dashboar.php" class="brand-link">
     <img src="<?= $main_url ?>asset/image/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          ...
          ?>
           <li class="nav-item <?= menuMaster() ?>">
             <a href="a" class="nav-link">
               <i class="nav-icon fas fa-solid fa-folder text-sm"></i>
               <p>Master<i class="fas fa-solid fa-angle-left right"></i></p>
             </a>
         ...
         <?php
          ...
          ?>
           <li class="nav-item <?= menuSetting() ?>">
             <a href="a" class="nav-link">
               <i class="nav-icon fas fa-solid fa-cog text-sm"></i>
               <p>Pengaturan<i class="fas fa-solid fa-angle-left right"></i></p>
             </a>
             <ul class="nav nav-treeview">
               <li class="nav-item">
